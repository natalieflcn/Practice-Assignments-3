...
//PRACTICE ASSIGNMENTS – DATA STRUCTURES, MODERN OPERATORS, AND STRINGS
...
//Write a function called spellWord that accepts a single string as
// an argument. This function should log to the console each letter
// of the argument separated by a space.

const spellWord = function (test) {
  console.log(...test);
};
